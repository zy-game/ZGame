...
namespace CarLogic
{
	public class CarSkillUseGasToTeam_ForSpeed : CarSkillUseItemToTeamOrOppTeam
	{
		public override CarSkillId ID => CarSkillId.ITEM_USE_GAS_TO_TEAM_ForSpeed;
