...
namespace CarLogic
{
	public class CarSkillFasterSmallGasForChipDragDirft : CarChipTechnologySkillBase
	{
		...
		public override CarSkillId ID => CarSkillId.DragDirft;
		...
		public override void OnActiveChange(bool active)
		{
			if (carState != null)
			{
				...
				instance.OnDragDirftComplete = (Action)Delegate.Remove(instance.OnDragDirftComplete, new Action(OnSkillComplete));
				...
				if (active)
				{
					...
					instance2.OnDragDirftComplete = (Action)Delegate.Combine(instance2.OnDragDirftComplete, new Action(OnSkillComplete));
