    ...
    public class PhysicsWorldManager : IPhysicsManager
    {
        ...
        public void AddBody(ICollider iCollider)
        {
            ...
            if (tsCollider.gameObject.transform.parent != null && tsCollider.gameObject.transform.parent.GetComponentInParent<TSCollider>() != null)
            {
                ...
                world.AddConstraint(new ConstraintHierarchy(parentCollider.Body, tsCollider.body, (tsCollider.GetComponent<TSTransform>().position + tsCollider.ScaledCenter) - (parentCollider.GetComponent<TSTransform>().position + parentCollider.ScaledCenter)));
            }

            tsCollider.body.FreezeConstraints = constraints;
        }
        ...
        {
            world.Events.RemovedRigidBody += delegate(RigidBody rb) { OnRemoveBody(rb); };
        }
