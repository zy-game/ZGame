...
namespace FixMath.NET
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        private static Fix64Random _random;

        public static Fix64Random Random
        {
            get
            {
                if (_random == null)
                {
                    _random = new Fix64Random(1);
                }
        ...
        public static Fix64 Sin(Fix64 x)
        {
            ...
            var secondNearestValue = new Fix64(SinLut[flipHorizontal ? SinLut.Length - 1 - (int)roundedIndex - SignI(indexError) : (int)roundedIndex + SignI(indexError)]);
