...
namespace ZGame
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        {
            BehaviourScriptable.instance.SetupUpdateEvent(Update);
            BehaviourScriptable.instance.SetupFixedUpdateEvent(FixedUpdate);
        ...
        public static void Uninitialized()
        {
            ...
            BehaviourScriptable.instance.UnsetupUpdateEvent(Update);
            BehaviourScriptable.instance.UnsetupFixedUpdateEvent(FixedUpdate);
