...
namespace TrueSync
{
    ...
    public abstract class TSCollider : MonoBehaviour, ICollider
    {
        ...
        [FormerlySerializedAs("isTrigger")] [SerializeField]
        ...
        public bool isTrigger
        {
            ...
            set
            {
                ...
                if (body != null)
                {
                    body.IsColliderOnly = _isTrigger;
                }
            }
        }
        ...
        [SerializeField] private TSVector center;
        ...
        {
            get { return TSVector.Scale(Center, lossyScale); }
        }
        ...
        {
            get { return this.body.BoundingBox; }
        }
        ...
        {
            if (body == null && PhysicsManager.instance != null)
            {
        ...
        public virtual void OnDrawGizmos()
        {
            ...
            Vector3 position = body != null ? body.Position.ToVector() : (transform.position + ScaledCenter.ToVector());
            Quaternion rotation = body != null ? body.Orientation.ToQuaternion() : transform.rotation;
