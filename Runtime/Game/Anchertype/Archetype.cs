...
{
    public partial class Archetype : IReference
    {
        ...
        {
            Archetype archetype = RefPooled.Spawner<Archetype>();
        ...
        public void Release()
        {
            components.ForEach(RefPooled.Release);
            idList.Clear();
            components.Clear();
        }
        ...
        public IComponent AddComponent(uint id)
        {
            ...
            component = (IComponent)RefPooled.Spawner(owner);
            idList.Add(id);
